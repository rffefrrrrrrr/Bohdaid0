...
1. شارك رابط الإحالة الخاص بك مع أصدقائك\n2. عندما يشترك شخص من خلال رابط الإحالة الخاص بك، ستحصل تلقائياً على يوم إضافي مجاني في اشتراكك\n3. لن يتم منح المكافأة إلا بعد اشتراك الشخص المُحال\n4. يمكنك متابعة إحالاتك ومكافآتك من خلال قائمة \"عرض إحالاتي\""""
        ...
        # Updated start_usage_info logic with formatted Session String instructions
        elif data == "start_usage_info":
            # Show detailed Session String instructions
            usage_text = """⚡️ *كيفية تشغيل البوت والحصول على Session String*

1️⃣ *الحصول على API ID و API Hash*
	1\\. ادخل على الموقع الرسمي: [my\\.telegram\\.org](https://my.telegram.org)
	2\\. سجّل الدخول برقم هاتفك \\(نفس الحساب اللي تريد ربطه مع البوت\\)
	3\\. بعد تسجيل الدخول، اختر: *API Development Tools*
	4\\. املأ البيانات المطلوبة:
	   • *App title*: أي اسم تختاره \\(مثلاً: MyApp\\)
	   • *Short name*: اسم مختصر \\(مثلاً: bot\\)
	   • باقي الخانات ممكن تتركها فارغة
	5\\. بعد الحفظ، ستظهر لك:
	   • *API ID* \\(رقم\\)
	   • *API Hash* \\(سلسلة حروف وأرقام طويلة\\)

⚠️ *مهم جداً*: لا تشارك هذه المعلومات مع أي شخص\\.
...
👉 [Session String Generator](https://telegram.tools/session-string-generator#telethon,user)
	...
	3\\. ضع:
	   • *API ID*
	   • *API Hash*
	   • رقم هاتفك \\(مع رمز الدولة، مثل: \\+212xxxxxxxxx للمغرب\\)
	4\\. راح يرسل لك تيليجرام كود تأكيد → انسخه وضعه في الموقع
	5\\. سيظهر لك *Session String*

⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻

3️⃣ *إدخال الـ Session String في البوت*
	• انسخ الـ *Session String* بالكامل
	• الصقه داخل البوت في المكان المطلوب \\(الواجهة أو الإعدادات\\)
	• بعد الحفظ، سيبدأ البوت بالعمل مباشرة بحسابك

✅ *تم\\! الآن البوت جاهز للاستخدام*

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

💡 *نصائح مهمة*:
• احتفظ بـ Session String في مكان آمن
• لا تشارك Session String مع أحد
• إذا تم اختراق Session String، قم بإلغاء الجلسة من إعدادات تيليجرام
• يمكنك إنشاء Session String جديد في أي وقت
